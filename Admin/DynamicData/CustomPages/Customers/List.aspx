    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            ...
                            Text="Edit" />&nbsp;<asp:HyperLink ID="DetailsHyperLink" runat="server"
            ...
            <div class="bottomhyperlink">
                <asp:HyperLink ID="InsertHyperLink" Enabled="false" runat="server"><img runat="server" src="~/Admin/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Insert new item</asp:HyperLink>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
