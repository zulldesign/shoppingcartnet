...
<script RunAt="server">
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        model.RegisterContext(typeof(InvertedSoftware.ShoppingCart.DataLayer.Dynamic.CartDataClassesDataContext), new ContextConfiguration() { ScaffoldAllTables = true });
